							...
							<div class="carousel-inner">
								...
								<div class="carousel-item">
									...
									<ul>
										...
										<li>The move of a Knight is considered as two steps in one direction and then one step in perpendicular direction forming a L shape. Thus, this path is considered while checking the number of blocking walls in the path. (A is valid but B is not.)</li>
									</ul>
								...
								<div class="carousel-item">
									...
									<ul>
									<li>The bishop cannot cross a cornered wall as shown in move C.</li>
									<li>The bishop can however cross a single wall from the edge as shown in move A or B.</li>
									</ul>
								...
								<div class="carousel-item">
									<h3>How to play:</h3>
									<ul>
										<li>To initiate a move, select the piece and then select the destination cell. The piece can be moved only if it is its valid movement and no other piece or wall is blocking its way.</li>
										<li>To rotate a board, just click on the respective Rotate button next to that board.</li>
										<li>Pay attention to the log message at the bottom-right of the screen for the match updates.</li>
									</ul>
								</div>
							</div>
